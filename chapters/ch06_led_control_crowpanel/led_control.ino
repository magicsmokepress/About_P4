...
static void build_ui(void) {
    ...
    lv_obj_set_style_radius(status_led, 40, 0);
    lv_obj_set_style_bg_color(status_led,
        lv_color_hex(0x616161), 0);
    lv_obj_set_style_border_width(status_led, 3, 0);
    lv_obj_set_style_border_color(status_led,
        lv_color_hex(0x333333), 0);
    lv_obj_set_style_shadow_width(status_led, 20, 0);
    lv_obj_set_style_shadow_color(status_led,
        lv_color_hex(0x00E676), 0);
    lv_obj_set_style_shadow_opa(status_led, 0, 0);
    ...
    lv_obj_set_style_bg_color(btn_on,
        lv_color_hex(0x00E676), LV_STATE_PRESSED);
    lv_obj_set_style_radius(btn_on, 20, 0);
    lv_obj_set_style_shadow_width(btn_on, 10, 0);
    lv_obj_set_style_shadow_color(btn_on,
        lv_color_hex(0x00C853), 0);
    lv_obj_add_event_cb(btn_on, btn_on_cb,
        LV_EVENT_CLICKED, NULL);

    lv_obj_t *lbl_on = lv_label_create(btn_on);
    lv_label_set_text(lbl_on, "ON");
    lv_obj_set_style_text_font(lbl_on,
        &lv_font_montserrat_48, 0);
    lv_obj_set_style_text_color(lbl_on,
    ...
    lv_obj_set_style_bg_color(btn_off,
        lv_color_hex(0xD32F2F), 0);
    lv_obj_set_style_bg_color(btn_off,
        lv_color_hex(0xEF5350), LV_STATE_PRESSED);
    lv_obj_set_style_radius(btn_off, 20, 0);
    lv_obj_set_style_shadow_width(btn_off, 10, 0);
    lv_obj_set_style_shadow_color(btn_off,
        lv_color_hex(0xD32F2F), 0);
    lv_obj_add_event_cb(btn_off, btn_off_cb,
        LV_EVENT_CLICKED, NULL);

    lv_obj_t *lbl_off = lv_label_create(btn_off);
    lv_label_set_text(lbl_off, "OFF");
    lv_obj_set_style_text_font(lbl_off,
        &lv_font_montserrat_48, 0);
    lv_obj_set_style_text_color(lbl_off,
        lv_color_hex(0xFFFFFF), 0);
    ...
    lv_obj_set_style_text_font(gpio_lbl,
        &lv_font_montserrat_14, 0);
    lv_obj_set_style_text_color(gpio_lbl,
