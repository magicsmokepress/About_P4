...
// IMPORTANT: SD and display share LDO4. Init order is part of each sketch's
// tested behavior - the ch18/ch19 sketches mount SD FIRST, then the display.
// Keep the order of the sketch you started from (see Chapter 18).
#define SD_CLK                 43
#define SD_CMD                 44
#define SD_D0                  39
