...
#define LV_STDARG_INCLUDE       <stdarg.h>
     ...
     *  512KB — matches monolith. Allocated from 32MB OPI PSRAM via ps_malloc.
     *  The old 128KB pool in internal SRAM was causing OOM with 10-tab setup UI. */
    ...
    /* Use ps_malloc to place the LVGL heap in PSRAM (32MB available) */
    #if LV_MEM_ADR == 0
